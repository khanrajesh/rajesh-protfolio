        ...
        <section className="time-line" id="time-line">
            <Container>
                <div>
                    ...
                    <TimeLineCard title="title" description="dess"/>
                    <TimeLineCard title="tlee" description="destts" date="2022 - 2023"/>
...
export const TimeLineCard = ({title, date, description}) => {
    return (
        <Col className="time-line-card" size={12} sm={6} md={4}>
            <div className="">
                <h6>{title} <span>({date})</span></h6>
                <p>{description}</p>
            </div>
        </Col>
    )
